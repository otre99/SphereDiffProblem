PROGRAM AdvectionDiffusionProblem
    ...
    use diff_user, only : fparam, kparam
    implicit none 
    ...
    phi0_path,ff0_path,sigma0_path,mulon0_path,mulat0_path,output_folder,npar,fparam,kparam
    ...
    call read_initial_data(species_(1),trim(phi0_path)//'U',ff0_path,sigma0_path,trim(mulon0_path)//'U',trim(mulat0_path)//'U')
    call read_initial_data(species_(2),trim(phi0_path)//'V',ff0_path,sigma0_path,trim(mulon0_path)//'V',trim(mulat0_path)//'V')
